// Если пользователь ставит галочку «запомнить меня» мы будем добавлять в куки хешированный идентификатор пользователя и хранить // все будем в контроллере документов «stayonlinesessions»
